    ...
    <div className="min-h-screen gradient-primary text-white">
      <div className="px-6 py-8">
        ...
        <div className="text-center mb-8">
          <img 
            src="https://images.unsplash.com/photo-1511895426328-dc8714191300?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&h=300" 
            alt="Happy family reading stories together" 
